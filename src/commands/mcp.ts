      ...
      content: [
        {
          ...
          text: [
            ...
            "nod validate",
            "nod preset list",
            "Generated projects are pnpm 11-first: run pnpm install, pnpm dev, pnpm build.",
            "AWS SAM projects use ESM .js output, a pnpm dependency layer, sam build --parallel, and scripts/check-sam-runtime-imports.js.",
            "For Lambda/SAM, prefer generated static Drizzle rate limits with DATABASE_POOL_MAX=2 and skip DB audit writes for GET, HEAD, and OPTIONS.",
          ].join("\n"),
        },
      ],
    };
