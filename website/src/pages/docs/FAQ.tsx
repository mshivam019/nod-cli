        ...
        <section className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <ol className="list-decimal list-inside space-y-1 ml-2">
              ...
              <li>Run <code>pnpm db:generate</code> to create a migration</li>
              <li>Run <code>pnpm exec drizzle-kit migrate --config=drizzle.config.ts</code> to apply changes</li>
            </ol>
          ...
          <div className="space-y-2">
            ...
            <p>
              If you are using Drizzle, the CLI automatically updates <code>src/db/schema.ts</code>. Run <code>pnpm exec drizzle-kit migrate --config=drizzle.config.ts</code> to create them.
            </p>
            <p>
