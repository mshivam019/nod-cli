    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Link to="/docs/components#frameworks" className="feature-card rounded-lg border p-4 block">
            <h3 className="font-semibold">Multiple Frameworks</h3>
            <p className="text-sm text-muted-foreground">
              Support for Express and Hono with TypeScript or JavaScript
            </p>
          </Link>
          <Link to="/docs/components#database" className="feature-card rounded-lg border p-4 block">
            <h3 className="font-semibold">Database Integration</h3>
            <p className="text-sm text-muted-foreground">
              PostgreSQL, MySQL, Supabase with Drizzle ORM
            </p>
          </Link>
          <Link to="/docs/components#authentication" className="feature-card rounded-lg border p-4 block">
            <h3 className="font-semibold">Authentication</h3>
            <p className="text-sm text-muted-foreground">
              JWT, JWKS, and Supabase Auth out of the box
            </p>
          </Link>
          <Link to="/docs/components#ai" className="feature-card rounded-lg border p-4 block">
            <h3 className="font-semibold">AI Features</h3>
            <p className="text-sm text-muted-foreground">
              RAG, Chat services, and Langfuse observability
            </p>
          </Link>
          <Link to="/docs/components#deployment" className="feature-card rounded-lg border p-4 block">
            <h3 className="font-semibold">Deployment Ready</h3>
            <p className="text-sm text-muted-foreground">
              Docker, PM2, Vercel cron, and GitHub Actions
            </p>
          </Link>
          <Link to="/docs/components#presets" className="feature-card rounded-lg border p-4 block">
