  ...
  return (
    <div className="space-y-6">
      ...
      <section className="space-y-4">
        ...
        <h3 className="font-semibold mt-4">Chat Service</h3>
        <CodeBlock
...
LANGFUSE_SECRET_KEY=sk-...`}
      ...
      <section className="space-y-4">
        ...
        <CodeBlock
          tsCode={`import { chatService } from './services/chat.service.js';
...
const history = await chatService.getHistory(conversation.id);`}
          jsCode={`import { chatService } from './services/chat.service.js';
